...
stw_me_030_fpu_c2p: src/main.c src/ui_map.c src/ui_tile.c src/settle_the_world_util.c src/ui_status.c exdev-gfx/exdev_gfx_ui_aos_030_fpu.lib exdev-gfx/exdev_gfx_aos_030_fpu_c2p.lib
	$(CC) -o ${@} ${INCLUDES_AOS} $(^) ${C_FLAGS_030_FPU} -DLOW_RESOLUTION ${LD_FLAGS_030_FPU} -LWork:workspace/c2plib/sdk -lc2p

stw_map_editor: stw_me_mos stw_me_060 stw_me_060_c2p stw_me_030_fpu_c2p
...
dist: stw_map_editor
	...
	cp -av stw_me_mos stw_me_060 stw_me_060_c2p stw_me_030_fpu_c2p ram:stw-map-editor/
...
clean:
	...
	$(RM) -f stw_meditor_mos stw_me_060 stw_me_060_c2p stw_me_030_fpu_c2p
