...
void ui_status_init(UIStatus_t *self, const int x, const int y, const int width, const int height, Tiles8bit_t *tiles) {
    ...
    self->quit = ui_icon_create(width - 20, 2, framebuffer_8bit_copy(tiles->tiles + TILES_TOTAL_NUM - TILES_BONUS_NUM - 2), NULL);
    ...
    self->save = ui_icon_create(width - 39, 2, framebuffer_8bit_copy(tiles->tiles + TILES_TOTAL_NUM - TILES_BONUS_NUM - 4), framebuffer_8bit_copy(tiles->tiles + TILES_TOTAL_NUM - TILES_BONUS_NUM - 3));
    ...
    self->variance = ui_icon_create(width - 58, 2, framebuffer_8bit_copy(tiles->tiles + TILES_TOTAL_NUM - TILES_BONUS_NUM - 1), NULL);
